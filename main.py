...
def backup(label: str, keep: int):
    ...
    Snapshots land in data/backups/patabrava-YYYYMMDD-HHMM.db.zip.
    """
...
@click.option("--out",  default=None, help="Output PDF path (default: data/patabrava_trend_YYYYMMDD.pdf)")
@click.option("--days", default=7, type=int, show_default=True, help="Window length")
def trend_report(out: str, days: int):
    """Generate the weekly Patabrava PDF trend report.
