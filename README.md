...
A Patabrava automatiza o ciclo completo:

| Sem Patabrava                                    | Com Patabrava                                              |
|-----------------------------------------------|---------------------------------------------------------|
...
DATABASE_URL=postgresql+psycopg2://user:pass@localhost:5432/patabrava
```
...
*Patabrava · Lead intelligence imobiliária · Portugal*
